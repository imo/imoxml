...
static PyTypeObject Element_Type = {
    ...
    "imoxml.etree.ElementTree.Element", sizeof(ElementObject), 0,
    /* methods */
...
static PyTypeObject ElementIter_Type = {
    ...
    /* Using the module's name since the pure-Python implementation does not
       have such a type. */
    "_imoelementtree._element_iterator",           /* tp_name */
...
static PyTypeObject TreeBuilder_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    "imoxml.etree.ElementTree.TreeBuilder", sizeof(TreeBuilderObject), 0,
    /* methods */
...
static PyTypeObject XMLParser_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    "imoxml.etree.ElementTree.XMLParser", sizeof(XMLParserObject), 0,
    /* methods */
...
PyInit__imoelementtree(void)
{
    ...
    if (!(st->elementpath_obj = PyImport_ImportModule("imoxml.etree.ElementPath")))
        return NULL;
    ...
    st->parseerror_obj = PyErr_NewException(
        "imoxml.etree.ElementTree.ParseError", PyExc_SyntaxError, NULL
        );
