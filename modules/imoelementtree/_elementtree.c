...
init_imoelementtree(void)
{
    ...
    m = Py_InitModule("_imoelementtree", _functions);
    if (!m)
        return;
    ...
    bootstrap = (
        ...
        "try:\n"
        "  from imoxml.etree import ElementTree\n"
        "except ImportError:\n"
        "  import ElementTree\n"
        "ET = ElementTree\n"
        "del ElementTree\n"

        "import _imoelementtree as cElementTree\n"
...
#else
    expat_capi = PyCObject_Import("_imoexpat", "expat_CAPI");
#endif
    if (expat_capi) {
